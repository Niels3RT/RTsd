	...
	function draw_tab_event() {
		...
		if (event_is_open) {
			if (session_is_open) {
				p_event_btn_open.style.background = '#f46666';
				p_event_btn_new.style.background = '#f46666';
				p_event_btn_close.style.background = '#f46666';
				p_event_btn_mod.style.background = '#f46666';
				allow_pedit = false;
			} else {
				p_event_btn_open.style.background = '#f46666';
				p_event_btn_new.style.background = '#f46666';
				p_event_btn_close.style.background = '#66f466';
				p_event_btn_mod.style.background = '#66f466';
				allow_pedit = true;
			}
		} else {
			p_event_btn_open.style.background = '#66f466';
			p_event_btn_new.style.background = '#66f466';
			p_event_btn_close.style.background = '#f46666';
			p_event_btn_mod.style.background = '#f46666';
			allow_pedit = false;
		}
	...
	function event_enable_pilot_edit() {
		if (allow_pedit) {
			p_event_btn_pedit_edit.style.background = '#66f466';
			if (do_pedit) {
				p_event_btn_pedit_toleft.style.background  = '#66f466';
				p_event_btn_pedit_pup.style.background     = '#66f466';
				p_event_btn_pedit_pdown.style.background   = '#66f466';
				p_event_btn_pedit_toright.style.background = '#66f466';
			} else {
				p_event_btn_pedit_toleft.style.background  = '#f46666';
				p_event_btn_pedit_pup.style.background     = '#f46666';
				p_event_btn_pedit_pdown.style.background   = '#f46666';
				p_event_btn_pedit_toright.style.background = '#f46666';
			}
		} else {
			p_event_btn_pedit_edit.style.background    = '#f46666';
			p_event_btn_pedit_toleft.style.background  = '#f46666';
			p_event_btn_pedit_pup.style.background     = '#f46666';
			p_event_btn_pedit_pdown.style.background   = '#f46666';
			p_event_btn_pedit_toright.style.background = '#f46666';
