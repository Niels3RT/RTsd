	...
	var hit_count = [0, 0, 0, 0];
	var lap_count = [0, 0, 0, 0];
	var lap_last_max = [0, 0, 0, 0];
	var det_level = [0, 0, 0, 0];
	var det_level_mod = [0, 0, 0, 0];
	var rssi_min = [0, 0, 0, 0];
	var rssi_max = [42, 42, 42, 42];
	var pos_fastest = [0, 1, 2, 3];
	var pos_fastest_lapnr = [0xff, 0xff, 0xff, 0xff];
	var pos_heat = [0, 1, 2, 3];
	var pos_heat_laps = [0, 0, 0, 0];
	var pos_heat_times = [0, 0, 0, 0];
